  ...
  ({ className, inset, children, ...props }, ref) => (
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(
        ...
        "focus:bg-[rgba(0,240,255,0.1)] focus:text-[#00f0ff]",
        "data-[state=open]:bg-[rgba(0,240,255,0.1)]",
        inset && "pl-8",
        className
      )}
      {...props}
  ...
  ({ className, ...props }, ref) => (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        ...
        "border-[rgba(0,240,255,0.2)] bg-[rgba(10,10,15,0.98)] backdrop-blur-xl",
  ...
  ({ className, inset, ...props }, ref) => (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "text-[#e4e4e7] focus:bg-[rgba(0,240,255,0.1)] focus:text-[#00f0ff]",
...
const DropdownMenuRadioItem = React.forwardRef(
  ({ className, children, ...props }, ref) => (
    ...
    >
      <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
        <DropdownMenuPrimitive.ItemIndicator>
          <Circle className="h-2 w-2 fill-[#00f0ff] text-[#00f0ff]" />
        </DropdownMenuPrimitive.ItemIndicator>
      </span>
      {children}
    </DropdownMenuPrimitive.RadioItem>
...
const DropdownMenuLabel = React.forwardRef(
  ({ className, inset, ...props }, ref) => (
    <DropdownMenuPrimitive.Label
      ref={ref}
      className={cn(
        "px-2 py-1.5 text-sm font-semibold text-[#00f0ff]",
        inset && "pl-8",
        className
      )}
      {...props}
...
const DropdownMenuSeparator = React.forwardRef(
  ({ className, ...props }, ref) => (
    <DropdownMenuPrimitive.Separator
      ref={ref}
      className={cn("-mx-1 my-1 h-px bg-[rgba(0,240,255,0.1)]", className)}
      {...props}
    />
  )
);
...
const DropdownMenuShortcut = ({ className, ...props }) => (
  <span
    className={cn("ml-auto text-xs tracking-widest text-[#52525b]", className)}
    {...props}
  />
);
